# Transfer manifest â€” always writes .aftermath/runs/<n>/summary.json

## Schedule A â€” Included (typical)

1. Git repository `theworker02/aftermath` (or content transfer)
2. Original Product source/docs as of closing tag
3. `docs/acquisition/` diligence materials
4. In-repo marks created for always writes .aftermath/runs/<n>/summary.json
